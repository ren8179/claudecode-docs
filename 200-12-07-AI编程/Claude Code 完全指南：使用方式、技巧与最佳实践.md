[[Claude Code]] [[AI编程工具]] [[技术教程]] [[最佳实践]] [[开发效率]] [[完全指南]] 

# [Claude Code 完全指南：使用方式、技巧与最佳实践](https://www.cnblogs.com/knqiufan/p/19449849)
...
| **Kimi K2** | `https://api.moonshot.cn/v1` | `kimi-k2` | [https://platform.moonshot.cn/console/account](https://platform.moonshot.cn/console/account) |
| **通义千问** | `https://dashscope.aliyuncs.com/compatible-mode/v1` | `qwen-coder-plus` | [https://bailian.console.aliyun.com/](https://bailian.console.aliyun.com/) |
| **DeepSeek** | `https://api.deepseek.com/v1` | `deepseek-coder` | [https://platform.deepseek.com/](https://platform.deepseek.com/) |
