...
![图片](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-juHiZfzUQ8.webp)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-IaT7XhDjEQ.png)
...
![图片](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-LFiBnhSuYt.webp)
...
![图片](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-6SrbZtbSHI.webp)

然后呢，在文章中一个有趣的评论，引起了我的注意。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-ZfFvTb55He.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-WA8tYcGHJv.png)

没想到，引起了好几个朋友非常正向的反馈。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-AUFF7VnnU5.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-AkuKtZI0kK.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-ErfDtuulho.png)

在GPT搜索了一阵子以后，就会给你推荐一个，在github上，几乎封神的项目。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-QTwSxAtgoK.png)

它叫做，yt-dlp。

github上143k的star，说是真神，也不为过。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-Uqbib5N8H7.png)

支持上千个网站。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-QFbsYmTNYv.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-0UZ4sJxaXW.png)

然后，Agent就会开始调用skill-creator这个生成器，开始分析yt-dlp这个项目，然后开始规划要怎么打包封装成一个Skill。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-ZziWSiMSnW.png)

规划了一通以后，OpenCode就分析完了，向我提出了几个问题。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-Z4p2DkgzkC.png)

我也给出了我的回答。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-DMqOk2KzCi.png)

然后它就会继续规划，最终给我一个非常明确的计划。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-Hd50aBE8uV.png)

我觉得没有问题了，这个时候，我就会切换到正式的开发模式。

也就是这个模式，然后发一句话，开始开发！

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-EFyPhT3XZ2.png)

OpenCode就会开始了。

过了一会，大概2分钟以后，这个基于yt-dlp的视频下载Skill，就开发完成了。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-X5wcrYHL76.png)

我们试一试。

比如OpenAI刚刚出的Youtube访谈视频，我想下载下来。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-QSnjBGm02I.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-8vRYrW4SVk.png)

第一次运行，其实会遇到很多问题，比如说Youtube防爬机制很强，需要你装个浏览器扩展导出Cookie，比如要安装一些其他的项目等等，不过这些AI都会指导你干好。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-nA6Ckx9nNZ.png)

然后一顿操作，这个项目，就下载好了，全程大概也就几分钟。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-OLf18yf5hY.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-G2uoAAqA01.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-OsOF1jnb8z.png)

于是，找到了Pake。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-HCDjb7wdg6.png)

Github上一个45k的超棒的项目，那就，直接Skill化，以后，你的网页开发完，直接就可以用Pake skill，一句话变成桌面APP。

你还可以，直接做一个究极万能的格式转化工厂。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-8WzSp48wSi.png)
...
![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-7CEdRPdgw9.png)

支持N种格式，真的。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-dhEwBRu3Ao.png)

甚至，你可以把著名的Ciphey，转成一个Skill。

从此，你就可以，在你的本地，配合Agent，直接破译密码。。。

![](ReadItLater%20Inbox/assets/Skills的最正确用法，是将整个Github压缩成你自己的超级技能库。-MgSwgoC5QV.png)
