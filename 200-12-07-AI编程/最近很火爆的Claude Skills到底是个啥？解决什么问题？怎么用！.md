[[Article]] #AI/Skills #Claude #MCP

# [最近很火爆的Claude Skills到底是个啥？解决什么问题？怎么用！](https://www.cnblogs.com/jinjiangongzuoshi/p/19440715)
...
![](ReadItLater%20Inbox/assets/最近很火爆的Claude%20Skills到底是个啥？解决什么问题？怎么用！-tKlA2jhHPj.png)
...
![](ReadItLater%20Inbox/assets/最近很火爆的Claude%20Skills到底是个啥？解决什么问题？怎么用！-8f4MjL0e24.png)
...
-   **官方Skills**，由Anthropic官方及合作伙伴提供。
    ...
    ![](ReadItLater%20Inbox/assets/最近很火爆的Claude%20Skills到底是个啥？解决什么问题？怎么用！-DiQMxFllrg.png)
    
    比如，你在 `Claude.ai` 网页版里用的那些丝滑功能 —— *比如“帮我开发一个Web应用”、“分析这个 PDF 文档”、“写一个贪吃蛇游戏并预览”*，它们背后的逻辑代码，都在这个仓库里！
...
-   **社区Skill**，由其他用户分享，直接拿来用，比自己造轮子快得多，非常适合做 Skills 选型和二次改造。下载后，上传即可，使用前注意安全性。
    ...
    ![](ReadItLater%20Inbox/assets/最近很火爆的Claude%20Skills到底是个啥？解决什么问题？怎么用！-D3lxU0L8EX.png)
    
    ```
    https://www.aitmpl.com/skills
    ```
    
    ![](ReadItLater%20Inbox/assets/最近很火爆的Claude%20Skills到底是个啥？解决什么问题？怎么用！-pGwGZXlS83.png)
